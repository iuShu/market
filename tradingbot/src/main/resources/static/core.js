...
const runningIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rocket-takeoff" viewBox="0 0 16 16">' +
    ...
    '</svg>'
const short_icon = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-graph-down-arrow" viewBox="0 0 16 16">\n' +
    '  <path fill-rule="evenodd" d="M0 0h1v15h15v1H0V0Zm10 11.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-1 0v2.6l-3.613-4.417a.5.5 0 0 0-.74-.037L7.06 8.233 3.404 3.206a.5.5 0 0 0-.808.588l4 5.5a.5.5 0 0 0 .758.06l2.609-2.61L13.445 11H10.5a.5.5 0 0 0-.5.5Z"/>\n' +
    '</svg>'
const long_icon = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-graph-up-arrow" viewBox="0 0 16 16">\n' +
...
const headCard = '<div class="accordion-item shadow">' +
    ...
    '<div class="col-1"><span>' + total_icon + ' {{ttl}}</span></div>' +
    '<div class="col-1"><span style="color: green">' + long_icon + ' {{long}}</span></div>' +
    '<div class="col-1"><span style="color: red">' + short_icon + ' {{short}}</span></div>' +
    '<div class="col-2"><b class="pe-2" style="color: {{color}}">PNL {{pnl}}</b>{{end}}</div>' +
    '<div class="col-1" title="8:00 ~ 21:00">' + sun_icon + ' {{day}}</div>' +
    '<div class="col-1" title="21:00 ~ 8:00">' + moon_icon + ' {{night}}</div>' +
    '</div></button></h2></div>'
